...
const coin2 = new Coin(1000, 500); // Adjust each by 6-700 minimum
...
function update(currentTime) {
  ...
  // Repeat until you love coding and before you find a smarter way
